...
class MA_PARTY_RATS(ParallelEnv):
    ...
    def __init__(self, render_mode="human", debug_mode=False, number_of_goblins=6):
        super().__init__()
        ...
        self.base_stats = {
            ...
            "goblin": {"hp": 7, "ac": 12, "to_hit_bonus": 4, "dex_modifier": 2},
        }
    ...
    def step(self, actions):
        ...
        for agent in self.agents:
            observations[agent] = observations[agent][:-4]
...
env = MA_PARTY_RATS(render_mode="human", debug_mode=True)
observations, infos = env.reset()
